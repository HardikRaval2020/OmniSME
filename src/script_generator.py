...
class ScriptGenerator:
    ...
    def __init__(self):
        self.llm = ChatOpenAI(model="gpt-4o", temperature=0.7, max_tokens=3000)
    ...
    def build(self, docs: List[Document], topic: str) -> str:
        ...
        if not chunks:
            raise ValueError(
                "YouTube transcripts contained no usable text after splitting. "
                "The videos may have empty or music-only captions."
            )
